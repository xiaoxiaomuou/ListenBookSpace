...
public class MyPageWidget extends View {
	...
	public MyPageWidget(Context context) {
		...
		mWidth = Tool.getwindowWidth(context);
		mHeight = Tool.getwindowHeight(context)-70;
		mPath0 = new Path();
		mPath1 = new Path();
		createDrawable();
	...
	public void abortAnimation() {
		if (!mScroller.isFinished()) {
			Log.d("hwang","this is abort the Animation!!");			
			mScroller.abortAnimation();
			//mScroller.forceFinished(!mScroller.isFinished());
		}
	}
